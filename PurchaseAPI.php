    ...
    public function create($data) {
        try {
            ...
            $sql = "INSERT INTO purchases (
                ...
                phone, street, city, postal_code, notes, inspection_date, inspection_time, company_info, cover_photo_index, cover_photo_uri, created_at, updated_at
            ) VALUES (
                :client_id, :client_name, :client_type, :spz, :purchase_date, :purchase_time, :purchase_state,
                :employee_id, :total_amount, :customer_price, :offered_price,
                :expected_sale_price, :is_vat_payer, :is_counter_account, :vin_verified, :source_knowledge,
                :phone, :street, :city, :postal_code, :notes, :inspection_date, :inspection_time, :company_info, :cover_photo_index, :cover_photo_uri, NOW(), NOW()
            )";
            ...
            $stmt->execute([
                ...
                ':purchase_time' => $data['purchaseTime'] ?? null,
                ...
                ':cover_photo_index' => $data['coverPhotoIndex'] ?? 0,
                ':cover_photo_uri' => $data['coverPhotoUri'] ?? null,
            ]);
            ...
            if (!empty($data['carDetails'])) {
                ...
                $sqlV = "INSERT INTO vehicles (
                    ...
                    pocet_vlastniku, pocet_provozovatelu,
