...
export function SpzInput({ label, value, onChangeText, placeholder, error = false }: SpzInputProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.inputWrapper, { backgroundColor: theme.inputBackground, borderColor }]}>
        <TextInput
