...
CREATE TABLE IF NOT EXISTS purchases (
    ...
    cover_photo_index INT NULL DEFAULT 0,
    cover_photo_uri VARCHAR(500) NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS vehicles (
    ...
    pocet_vlastniku INT NULL,
    pocet_provozovatelu INT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Employees table (synced from auth server)
...
CREATE TABLE IF NOT EXISTS push_tokens (
    ...
    device_type VARCHAR(50) NOT NULL DEFAULT 'ios',
...
-- Migration statements to add new columns to vehicles table
-- (Run manually as needed)
-- ALTER TABLE vehicles ADD COLUMN pocet_vlastniku INT NULL AFTER has_ai_wheels;
-- ALTER TABLE vehicles ADD COLUMN pocet_provozovatelu INT NULL AFTER pocet_vlastniku;

-- Migration statements to add new columns to purchases table
-- (Run manually as needed)
-- ALTER TABLE purchases ADD COLUMN purchase_time TIME NULL AFTER purchase_date;
-- ALTER TABLE purchases ADD COLUMN inspection_time TIME NULL AFTER inspection_date;
-- ALTER TABLE purchases ADD COLUMN cover_photo_index INT NULL DEFAULT 0 AFTER photos;
-- ALTER TABLE purchases ADD COLUMN cover_photo_uri VARCHAR(500) NULL AFTER cover_photo_index;

-- Migration statements to add VIN verification toggles to vehicles table
-- (Run manually as needed)
-- ALTER TABLE vehicles ADD COLUMN cebia TINYINT(1) NOT NULL DEFAULT 0 AFTER pocet_provozovatelu;
-- ALTER TABLE vehicles ADD COLUMN ca_vertical TINYINT(1) NOT NULL DEFAULT 0 AFTER cebia;

-- Migration statements to add new columns to vehicles table for cebia and caVertical
-- (Run manually as needed)
-- ALTER TABLE vehicles ADD COLUMN cebia VARCHAR(255) NULL AFTER pocet_provozovatelu;
-- ALTER TABLE vehicles ADD COLUMN caVertical VARCHAR(255) NULL AFTER cebia;

-- Migration statements to add service_notes column to purchases table
-- (Run manually as needed)
-- ALTER TABLE purchases ADD COLUMN service_notes TEXT NULL AFTER notes;