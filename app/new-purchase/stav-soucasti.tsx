...
export default function StavSoucastiScreen() {
  const { generalNotes: contextGeneralNotes, serviceNotes: contextServiceNotes, setGeneralNotes: setContextGeneralNotes, setServiceNotes: setContextServiceNotes } = usePurchases();
  ...
  const [generalNotes, setGeneralNotes] = useState(contextGeneralNotes);
  const [serviceNotes, setServiceNotes] = useState(contextServiceNotes);

  // Sync local state to context when component mounts or values change
  useEffect(() => {
    setContextGeneralNotes(generalNotes);
  }, [generalNotes]);

  useEffect(() => {
    setContextServiceNotes(serviceNotes);
  }, [serviceNotes]);
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Servisní poznámka</Text>
          <View style={styles.inputContainer}>
            <TextInput
              style={styles.multilineInput}
              value={serviceNotes}
